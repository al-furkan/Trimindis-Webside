                ...
                <div class="sidebar_blog_1">
                    <div class="sidebar-header">
                        <div class="logo_section">
                            <a href="index.html"><img class="logo_icon img-responsive" src="images/logo/image.png"
                    ...
                    <ul class="list-unstyled components">
                        <li class="active">
                            <a href="#dashboard" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                                <i class="fa fa-dashboard yellow_color"></i> <span>Hero Section</span>
                            </a>
                            <ul class="collapse list-unstyled" id="dashboard">
                                <li><a href="./Home-Hero/insert.php">> <span>Insert</span></a></li>
                                <li><a href="./Home-Hero/view.php">> <span>View</span></a></li>
                            </ul>
                        </li>

                        <li>
                            <a href="#aboutus" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                                <i class="fa fa-diamond purple_color"></i> <span>About Us</span>
                            </a>
                            <ul class="collapse list-unstyled" id="aboutus">
                                <li><a href="./aboutus/insert.php">> <span>Insert</span></a></li>
                                <li><a href="./aboutus/view.php">> <span>View</span></a></li>
                            </ul>
                        </li>

                        <li>
                            <a href="#services" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                                <i class="fa fa-diamond purple_color"></i> <span>Service Section</span>
                            </a>
                            <ul class="collapse list-unstyled" id="services">
                                <li><a href="./service/insert.php">> <span>Insert</span></a></li>
                                <li><a href="./service/view.php">> <span>View</span></a></li>
                            </ul>
                        </li>

                        <li>
                            <a href="#blog" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                                <i class="fa fa-diamond purple_color"></i> <span>Blog Section</span>
                            </a>
                            <ul class="collapse list-unstyled" id="blog">
                                <li><a href="./blog/insert.php">> <span>Insert</span></a></li>
                                <li><a href="./blog/view.php">> <span>View</span></a></li>
                            </ul>
                        </li>

                        <li>
                            <a href="#team" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                                <i class="fa fa-diamond purple_color"></i> <span>Team Section</span>
                            </a>
                            <ul class="collapse list-unstyled" id="team">
                                <li><a href="./team/insert.php">> <span>Insert</span></a></li>
                                <li><a href="./team/view.php">> <span>View</span></a></li>
                            </ul>
                        </li>

                        <li>
                            <a href="#project" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                                <i class="fa fa-diamond purple_color"></i> <span>Project Section</span>
                            </a>
                            <ul class="collapse list-unstyled" id="project">
                                <li><a href="./project/insert.php">> <span>Insert</span></a></li>
                                <li><a href="./project/view.php">> <span>View</span></a></li>
                            </ul>
                        </li>
